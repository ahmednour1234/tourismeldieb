...
return [
    ...
    'register' => 'إنشاء حساب',
    'register_subtitle' => 'احجز بشكل أسرع وتابع رحلاتك.',
    'name' => 'الاسم الكامل',
    'have_account' => 'لديك حساب بالفعل؟',
    'no_account' => 'مستخدم جديد؟',

    'admin_login' => 'دخول المسؤول',
    'admin_login_subtitle' => 'سجّل الدخول إلى لوحة التحكم.',
    'not_staff' => 'هذا الحساب ليس لديه صلاحية الدخول للوحة التحكم.',
    'back_to_site' => 'العودة إلى الموقع',
    'login' => 'تسجيل الدخول',
    'login_subtitle' => 'سجّل الدخول لإدارة حجوزاتك ورحلاتك.',
